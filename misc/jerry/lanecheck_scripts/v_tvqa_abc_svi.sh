...
#SBATCH --ntasks=6
#SBATCH --gres=gpu:1
#SBATCH -o /home/jumperkables/kable_management/v_tvqa_abc_svi.out
#jumperkables
#crhf63
...
python /home/jumperkables/kable_management/mk8+-tvqa/mystuff/validate.py \
    ...
    --lanecheck True \
    --device 0 \
    --lanecheck_path /home/jumperkables/kable_management/mk8+-tvqa/dataset_paper/jerry/results/tvqa_abc_svi/lanecheck_dict.pickle \
    --test_bsz 2 \
    --dset=valid
    #--poolnonlin lrelu \
    #--pool_dropout 0.5 \
