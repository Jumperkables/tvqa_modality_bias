...
#SBATCH --job-name=tvqa_abc_vi_bert
#SBATCH --ntasks=6
#SBATCH --gres=gpu:1
#SBATCH -o /home/jumperkables/kable_management/v_tvqa_abc_vi_bert.out
#jumperkables
#crhf63
...
python /home/jumperkables/kable_management/mk8+-tvqa/mystuff/validate.py \
    ...
    --best_path /home/jumperkables/kable_management/mk8+-tvqa/dataset_paper/jerry/results/tvqa_abc_vi_bert/best_valid.pth \
